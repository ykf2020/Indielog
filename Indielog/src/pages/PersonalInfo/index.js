          ...
          <ModalBackground>
            {mode === 1 && (
              <ModalPanel>
                ...
                <ModalInnerTop>
                  ...
                  <ModalUploadButton htmlFor="post-image">
                    上傳圖片
                  </ModalUploadButton>
                  <input
                    type="file"
            ...
            {mode === 3 && (
              <ModalPanel>
                ...
                <ModalInnerBottom>
                  <ModalButton onClick={handleEditDisplayName}>
                    送出
                  </ModalButton>
                  <ModalButton
                    onClick={() => {
            ...
            {mode === 4 && (
              <ModalPanel>
                ...
                <ModalInnerBottom>
                  <ModalButton onClick={handleEditIntroduction}>
                    送出
                  </ModalButton>
                  <ModalButton
                    onClick={() => {
