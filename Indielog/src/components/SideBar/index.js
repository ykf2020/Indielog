  ...
  return (
    <SidebarContainer isOpenSideBar={isOpenSideBar}>
      <SidebarMenu>
        ...
        <SidebarLink to="/blog" onClick={toggleSideBar}>
          聊聊音樂
        </SidebarLink>
        {user ? (
          <SidebarLink to="/new-song" onClick={toggleSideBar}>
            上傳音樂
          </SidebarLink>
        ) : (
          ""
        ...
        {user ? (
          <SidebarLink to="/new-post" onClick={toggleSideBar}>
            新增文章
          </SidebarLink>
        ) : (
          ""
        ...
        {user ? (
          <SidebarLink to="/member/collections/songs" onClick={toggleSideBar}>
            收藏列表
          </SidebarLink>
        ) : (
          ""
        ...
        {user ? (
          <SidebarLink to="/member/personal-info" onClick={toggleSideBar}>
            會員資料
          </SidebarLink>
        ) : (
          ""
