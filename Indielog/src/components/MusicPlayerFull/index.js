...
const MusicPlayerFull = ({ audioRef }) => {
  ...
  const songPlayingInfo = useSelector(
    (store) => store.playerControl.songPlayingInfo
  );
  ...
  function dragHandler(e) {
    ...
    dispatch(
      setSongPlayingInfo({ ...songPlayingInfo, currentTime: e.target.value })
    );
  }
        ...
        <BodyContainer>
          ...
          <Song mode={mode}>
            ...
            <ControlPanel>
              <Slider>
                <SongCurrentTime>
                  {getTime(songPlayingInfo.currentTime)}
                </SongCurrentTime>
                <Track>
                  <InputRange
                    min={0}
                ...
                <SongFullTime>
                  {getTime(songPlayingInfo.duration || 0)}
                </SongFullTime>
              </Slider>
              <Buttons>
                <LoopButton
